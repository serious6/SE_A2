...
import assoziation.impl.OneToManyReturnB;
...
public class OneToManyBTest {
	...
	public void fixture() {
		...
		auf4 = new Order(3);
		auf5 = new Order(4);
		auftragliste1 = new OneToManyReturnB<Order>(new Factory<Order>() {
			@Override
	...
	@Test
	public void testAdd() {
		assertTrue(auftragliste1.add(auf2));
		// Zweimal Auftr�ge mit der selben Auftragsnummer werden nicht
		// hinzugef�gt
		assertFalse(auftragliste1.add(auf3));
		// Wir versuchen zwei identische Auftr�ge hinzuzuf�gen
		assertFalse(auftragliste1.add(auf2));
		// Test auf Nullelement
		assertFalse(auftragliste1.add(null));
	}

	@Test
	public void testRemove() {
		auftragliste1.add(auf2);
		assertTrue(auftragliste1.remove(auf2));
		// Auftrag der nicht vorhanden ist kann nicht gel�scht werden
		assertFalse(auftragliste1.remove(auf1));
		// Null Element entfwrnen
		assertFalse(auftragliste1.remove(null));
	}
	...
	public void testSize() {
		...
		auftragliste1.add(auf2);
		auftragliste1.add(auf4);
		// Pruefung, ob die Groesse der Liste gleich der Anzahl der hinzugefuegten Elemente ist
